...
public interface ContentManifest {
  ...
  public static final class ContentManifestPayload extends
    ...
    public static final class FileMapping extends
      ...
      public ContentManifest.ContentManifestPayload.FileMapping.ChunkData[] chunks;
      ...
      public FileMapping clear() {
        ...
        chunks = ContentManifest.ContentManifestPayload.FileMapping.ChunkData.emptyArray();
        linktarget = "";
        unknownFieldData = null;
        cachedSize = -1;
        return this;
      ...
      public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
        ...
        if (this.chunks != null && this.chunks.length > 0) {
          for (int i = 0; i < this.chunks.length; i++) {
            ContentManifest.ContentManifestPayload.FileMapping.ChunkData element = this.chunks[i];
            if (element != null) {
              output.writeMessage(6, element);
            }
          }
        }
        if (!this.linktarget.equals("")) {
          output.writeString(7, this.linktarget);
        }
        super.writeTo(output);
      }
      ...
      protected int computeSerializedSize() {
        ...
        if (!this.linktarget.equals("")) {
          size += com.google.protobuf.nano.CodedOutputByteBufferNano
              .computeStringSize(7, this.linktarget);
        }
        return size;
      }
        ...
        while (true) {
          ...
          switch (tag) {
            ...
            case 50: {
              ...
              ContentManifest.ContentManifestPayload.FileMapping.ChunkData[] newArray =
                  new ContentManifest.ContentManifestPayload.FileMapping.ChunkData[i + arrayLength];
              if (i != 0) {
                System.arraycopy(this.chunks, 0, newArray, 0, i);
              }
              for (; i < newArray.length - 1; i++) {
                newArray[i] = new ContentManifest.ContentManifestPayload.FileMapping.ChunkData();
            ...
            case 58: {
              this.linktarget = input.readString();
              break;
            }
          }
        }
    ...
    public ContentManifest.ContentManifestPayload.FileMapping[] mappings;
    ...
    public ContentManifestPayload clear() {
      mappings = ContentManifest.ContentManifestPayload.FileMapping.emptyArray();
      unknownFieldData = null;
      cachedSize = -1;
      return this;
    }
    ...
    public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
      ...
      if (this.mappings != null && this.mappings.length > 0) {
        for (int i = 0; i < this.mappings.length; i++) {
          ContentManifest.ContentManifestPayload.FileMapping element = this.mappings[i];
          if (element != null) {
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 10: {
            ...
            ContentManifest.ContentManifestPayload.FileMapping[] newArray =
                new ContentManifest.ContentManifestPayload.FileMapping[i + arrayLength];
            if (i != 0) {
              System.arraycopy(this.mappings, 0, newArray, 0, i);
            }
            for (; i < newArray.length - 1; i++) {
              newArray[i] = new ContentManifest.ContentManifestPayload.FileMapping();
              input.readMessage(newArray[i]);
              input.readTag();
            }
            // Last one without readTag.

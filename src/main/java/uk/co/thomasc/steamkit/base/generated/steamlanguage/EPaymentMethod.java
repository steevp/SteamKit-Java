...
public enum EPaymentMethod {
	None(0), ActivationCode(1), CreditCard(2), Giropay(3), PayPal(4), Ideal(5), PaySafeCard(6), Sofort(7), GuestPass(8), WebMoney(9), HardwarePromo(16), ClickAndBuy(32), AutoGrant(64), Wallet(128), OEMTicket(256), Split(512), Complimentary(1024), ;

 ...
 * {@link SteamWorkshop#requestPublishedFileDetails(long)}.
 */
public final class PublishedFileDetailsCallback extends CallbackMsg {
	...
	/**
	 * Gets the handle for the UGC preview file this published file represents,
	 * normally an image or thumbnail.
	 */
	@Getter

...
import uk.co.thomasc.steamkit.base.generated.steamlanguageinternal.msg.MsgClientCreateChat;
...
import uk.co.thomasc.steamkit.steam3.handlers.steamchat.callbacks.ChatActionResultCallback;
import uk.co.thomasc.steamkit.steam3.handlers.steamchat.callbacks.ChatEnterCallback;
import uk.co.thomasc.steamkit.steam3.handlers.steamchat.callbacks.ChatInviteCallback;
import uk.co.thomasc.steamkit.steam3.handlers.steamchat.callbacks.ChatMemberInfoCallback;
import uk.co.thomasc.steamkit.steam3.handlers.steamchat.callbacks.ChatMsgCallback;
import uk.co.thomasc.steamkit.steam3.handlers.steamchat.callbacks.ChatCreateResponseCallback;
...
public final class SteamChat extends ClientMsgHandler {
	...
	void handleChatInvite(IPacketMsg packetMsg) {
		final ClientMsgProtobuf<SteammessagesClientserver.CMsgClientChatInvite> chatInvite = new ClientMsgProtobuf<SteammessagesClientserver.CMsgClientChatInvite>(SteammessagesClientserver.CMsgClientChatInvite.class, packetMsg);

		final ChatInviteCallback callback = new ChatInviteCallback(chatInvite.getBody());
		getClient().postCallback(callback);
